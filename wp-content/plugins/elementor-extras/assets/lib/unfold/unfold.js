				...
				if ( false !== plugin.opts.visible_lines ) {
					...
					$elems.each( function( index ) {
						...
						if ( counter < plugin.opts.visible_lines ) {
							...
							// console.log( "height", this + " = " + $(this).outerHeight() );
							// console.log( "display", this + " = " + $(this).css('display') );

							// console.log( "line-height", this + " = " + plugin.getLineHeight( this ) );
							// console.log( "margin-top", this + " = " + style.marginTop );
							// console.log( "margin-bottom", this + " = " + style.marginBottom );
							...
							if ( lines > 1 ) {
								...
								for( i = 1; i <= lines; i++ ) { 
									...
									if ( counter < plugin.opts.visible_lines ) {
										...
										// console.log( "added margin", this + ": " + lineHeight );
								...
								// console.log( "added margin", this + ": " + $(this).outerHeight(true) );
