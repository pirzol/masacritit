 ...
 * @since 1.4.0
 */
class Group_Control_Button_Effects extends Group_Control_Base {
		...
		$controls['easing'] = [
			...
			'selectors' => [
				'{{SELECTOR}} .ee-button:before,
				 ...
				 {{SELECTOR}} .ee-button > *,
				 {{SELECTOR}} .ee-button' => 'transition-timing-function: {{VALUE}}',
			],
			'condition' 	=> [
				'type!' 	=> ''
			]
		...
		$controls['duration'] = [
			...
			'selectors' 	=> [
				'{{SELECTOR}} .ee-button:before,
				 {{SELECTOR}} .ee-button:after,
				 {{SELECTOR}} .ee-button > *,
				 {{SELECTOR}} .ee-button' => 'transition-duration: {{VALUE}}s;',
			],
			'separator' 	=> 'after',
		];
