			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php else :
                    ...
                    <?php if ( API::STATUS_SITE_INACTIVE === $license_data['license'] ) : ?>
                        <p><?php echo __( '<strong>Your license key doesn\'t match your current domain.</strong> This is most likely due to a change in the domain URL. Please deactivate the license and then reactivate it again.', 'elementor-pro' ); ?></p>
                    <?php endif; ?>
